...
"""
Layers 2D: 
(1) Conv2d_NN (Convolutional Nearest Neighbor Layer w/ Pixel Shuffle, Coordinate Encoding, Similarity and Aggregation Types, and 3 Sampling Types) 
(2) Conv2d_NN_Attn (Convolutional Nearest Neighbor Attention Layer w/ Pixel Shuffle, Coordinate Encoding, Similarity and Aggregation Types, and 3 Sampling Types) 
(3) Conv2d_Branching (Convolutional Nearest Neighbor Layer with Convolution Branching)
(4) Conv2d_Attn_Branching (Convolutional Nearest Neighbor Attention Layer with Convolution Branching)
"""
import torch 
