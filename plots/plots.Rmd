...
gflops_plot <- ggplot(df_long_offset, aes(x = N, y = GFlops_offset, color = Type, linetype = Type)) + # Use the offset Y-value and add linetype
  geom_line(linewidth = 1) +
  
  # --- Color scale (Your code) ---
  scale_color_manual(
    name = "Sampling Method",
    labels = c(Rand = "Random (N^2)", Spat = "Spatial (N)", All = "All Features", Conv = "Conv2d (baseline)"),
