...
python allconvnet_main.py --layer ConvNN --num_layers 3 --channels 32 16 8 --K 9 --sampling_type all --num_epochs 75 --coordinate_encoding --output_dir ./Output/Aug_30_Sanity/ConvNN_All_K9 --padding 1 -device mps
