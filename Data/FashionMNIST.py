'''Fashion MNIST 2D data for training 2D CNN Models'''
...
### Classification Data - FashionMNIST ###
class FashionMNIST:
...
### Denoising Data - NoisyFashionMNIST###
...
# fashionmnist_noise = FashionMnist_denoise(noise_std=0.5)
# print(fashionmnist_noise.shape())
# fashionmnist_noise.visual()