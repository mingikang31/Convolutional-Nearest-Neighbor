...
class EncoderLayer(nn.Module):
    def __init__(self, d_model, num_heads, d_ff):
        ...
        # self.dropout1 = nn.Dropout(dropout) # maybe added later 
...
class Transformer(nn.Module): 
    def __init__(self, src_vocab_size, tgt_vocab_size, d_model, num_heads, num_layers, d_ff, max_seq_length, dropout = 0):
