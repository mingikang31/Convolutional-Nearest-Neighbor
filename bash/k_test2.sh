    ...
    for br in "${BRANCH_RATIOS[@]}"; do
        for ks in "${KERNEL_SIZES[@]}"; do
            for k in "${K_VALUES[@]}"; do
                ...
                output_dir="./Final_Output/K_test_pt2/VGG11-$(echo $dataset | awk '{print toupper($0)}')/BranchingConvNN_K${k}_KS${ks}_col_col_br${br_fmt}_s42"
...
python main.py \
    ...
    --device cuda \
    --seed 42 \
    --output_dir ./Final_Output/K_test_pt2/VGG11-CIFAR10/BranchingConvNN_K0_KS3_col_col_br0000_s42 \
    --num_epochs 100
...
python main.py \
    ...
    --device cuda \
    --seed 42 \
    --output_dir ./Final_Output/K_test_pt2/VGG11-CIFAR10/BranchingConvNN_K0_KS2_col_col_br0000_s42 \
    --num_epochs 100
...
python main.py \
    ...
    --device cuda \
    --seed 42 \
    --output_dir ./Final_Output/K_test_pt2/VGG11-CIFAR10/BranchingConvNN_K0_KS1_col_col_br0000_s42 \
    --num_epochs 100
...
python main.py \
    ...
    --device cuda \
    --seed 42 \
    --output_dir ./Final_Output/K_test_pt2/VGG11-CIFAR100/BranchingConvNN_K0_KS3_col_col_br0000_s42 \
    --num_epochs 100
...
python main.py \
    ...
    --device cuda \
    --seed 42 \
    --output_dir ./Final_Output/K_test_pt2/VGG11-CIFAR100/BranchingConvNN_K0_KS2_col_col_br0000_s42 \
    --num_epochs 100
...
python main.py \
    ...
    --device cuda \
    --seed 42 \
    --output_dir ./Final_Output/K_test_pt2/VGG11-CIFAR100/BranchingConvNN_K0_KS1_col_col_br0000_s42 \
    --num_epochs 100
