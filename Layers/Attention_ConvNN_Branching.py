...
from Conv2d_NN_Attn_spatial import *
...
if __name__ == "__main__":
    ...
    attention_convnn_attn_spatial_branching = Attention_ConvNN_Attn_Spatial_Branching(in_ch=3, out_ch=16, channel_ratio=(16, 16), kernel_size=3, K=3, samples=8, shuffle_pattern="NA", shuffle_scale=1, num_heads=1, location_channels=False)
    output_attention_spatial = attention_convnn_attn_spatial_branching(ex)
    print("Output Attention Spatial Branching: ", output_attention_spatial.shape)
