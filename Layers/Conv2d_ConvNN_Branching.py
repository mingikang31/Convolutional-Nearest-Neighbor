...
if __name__ == "__main__":
    ...
    # Conv2d + ConvNN Attention Branching
    conv2d_convnn_attn_spatial_branching = Conv2d_ConvNN_Attn_Spatial_Branching(3, 16, channel_ratio=(16, 16), kernel_size=3, K=9, samples=8, shuffle_pattern="NA", shuffle_scale=1, location_channels=False)
    output_attn_spatial = conv2d_convnn_attn_spatial_branching(ex)
    print("Output Attention Spatial Branching: ", output_attn_spatial.shape)
