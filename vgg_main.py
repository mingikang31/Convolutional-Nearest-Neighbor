...
def args_parser():
    ...
    # Model Arguments
    parser.add_argument("--model", type=str, default="vgg11", choices=["vgg11", "vgg13", "vgg16", "vgg19"], help="Model architecture to use") 

    parser.add_argument("--layer", type=str, default="ConvNN", choices=["Conv2d", "ConvNN", "ConvNN_Attn", "Branching", "Branching_Attn"], help="Type of Convolution or Attention layer to use")
