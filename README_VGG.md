...
**1. 1D Neural Network Layers (`vgg_layers.py`)**: These are 1D layers operating directly on image-like feature maps.
...
**2. 2D Neural Network Layers (`vgg_layers.py`)**: These are 2D layers operating directly on image-like feature maps.
...
### Main Script (`vgg_main.py`)

Run `python vgg_main.py --help` to see all available options.

#### Model & Layer Configuration

| Flag | Default | Choices | Description |
|------|---------|---------|-------------|
| `--model` | `vgg11` | `vgg11`, `vgg13`, `vgg16`, `vgg19` | Model architecture to use |
| `--layer` | `ConvNN` | `Conv2d`, `ConvNN`, `ConvNN_Attn`, `Branching`, `Branching_Attn` | Type of convolution or attention layer to use |
...
| Flag | Default | Choices | Description |
|------|---------|---------|-------------|
| `--dataset` | `cifar10` | `cifar10`, `cifar100` | Dataset to use for training and evaluation |
