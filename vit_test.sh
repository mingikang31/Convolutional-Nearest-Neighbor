...
# # Conv1d
# python vit_main.py --layer Conv1d --patch_size 16 --num_layers 12 --K 9 --num_heads 3 --d_hidden 192 --d_mlp 768 --dropout 0.1 --attention_dropout 0.1 --dataset cifar10 --num_epochs 10 --seed 0 --output_dir ./Output/ViT-Tiny/Conv1d

# # Conv1d Attention
# python vit_main.py --layer Conv1dAttention --patch_size 16 --num_layers 12 --K 9 --num_heads 3 --d_hidden 192 --d_mlp 768 --dropout 0.1 --attention_dropout 0.1 --dataset cifar10 --num_epochs 10 --seed 0 --output_dir ./Output/ViT-Tiny/Conv1dAttention
