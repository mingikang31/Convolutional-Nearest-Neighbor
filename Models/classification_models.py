...
def classification_check():
    ...
    models = [CNN(), 
                ...
                ConvNN_2D_K_All(shuffle_pattern="BA", shuffle_scale=2), 
                ConvNN_2D_K_N(shuffle_pattern="BA", shuffle_scale=2), ConvNN_2D_Spatial_K_N(shuffle_pattern="BA", shuffle_scale=2),
                ConvNN_2D_K_All_Location(shuffle_pattern="BA", shuffle_scale=2), 
                ConvNN_2D_K_N_Location(shuffle_pattern="BA", shuffle_scale=2), 
                ConvNN_2D_Spatial_K_N_Location(shuffle_pattern="BA", shuffle_scale=2),

                ConvNN_2D_Attn_K_All(shuffle_pattern="BA", shuffle_scale=2), 
                ConvNN_2D_Attn_K_N(shuffle_pattern="BA", shuffle_scale=2), 
                ConvNN_2D_Attn_Spatial_K_N(shuffle_pattern="BA", shuffle_scale=2),
                ConvNN_2D_Attn_V_K_All(shuffle_pattern="BA", shuffle_scale=2),
                ConvNN_2D_Attn_V_K_N(shuffle_pattern="BA", shuffle_scale=2),

                Attention_2D(shuffle_pattern="BA", shuffle_scale=2),

                Local_Global_ConvNN_2D(), 
                Global_Local_ConvNN_2D(), 

                B_Conv2d_ConvNN_K_All(shuffle_pattern="BA", shuffle_scale=2),
                B_Conv2d_ConvNN_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Conv2d_ConvNN_Spatial_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Conv2d_ConvNN_Attn_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Conv2d_ConvNN_Attn_Spatial_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Conv2d_ConvNN_Attn_V_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Attention_ConvNN_K_All(shuffle_pattern="BA", shuffle_scale=2),
                B_Attention_ConvNN_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Attention_ConvNN_Spatial_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Attention_ConvNN_Attn_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Attention_ConvNN_Attn_Spatial_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Attention_ConvNN_Attn_V_K_N(shuffle_pattern="BA", shuffle_scale=2),
                B_Attention_Conv2d(shuffle_pattern="BA", shuffle_scale=2),
